                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                @if(isset($blogger))
                                    <form method="POST" action="{{ route('bloggers.update', $blogger) }}" id="blogger-form-edit" autocomplete="off">
                                        @method('PATCH')
                                        @else
                                            <form method="POST" action="{{ route('bloggers') }}">
                                                @endif
                                                @csrf
